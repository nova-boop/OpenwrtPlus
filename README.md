<div align="center">
<img width="768" src="https://cdn.jsdelivr.net/gh/py95/OpenwrtPlus/images/openwrt.png"/>
<h1>OpenWrt — X86固件云编译</h1>
...
- X86版本 ，集成 Docker 
  ...
  - 集成驱动
    ...
    - 虚拟化
    - UVC视频推流-mjpg
    - QCA9880无线网卡(有此网卡的会造成开机卡5分钟，不影响使用，正常驱动网卡)
- VM 虚拟机版本(无 Dokcer )
  - 打包各种虚拟机镜像版本,适合做旁路
    - rootfs.tar.gz (Dokcer Container，自定查找教程导入) 
    - ISO
    - QCOW2 (PVE)
    - VMDK  (VMware)
    - VHDX  (Hyper-v)
...
6. 编译大概需要2-3小时，编译完成后在仓库主页 [Releases](https://github.com/py95/OpenwrtPlus/releases) 对应 Tag 标签内下载固件
<details>
